...
import { AfterAll, BeforeAll, Test, TestContext } from '@athenna/test'
...
export default class TestRequestTest {
  ...
  @Test()
  public async shouldBeAbleToMakeAGetRequestUsingRequestPlugin({ request }: TestContext) {
  ...
  @Test()
  public async shouldBeAbleToMakeAHeadRequestUsingRequestPlugin({ request }: TestContext) {
  ...
  @Test()
  public async shouldBeAbleToMakeAnOptionsRequestUsingRequestPlugin({ request }: TestContext) {
  ...
  @Test()
  public async shouldBeAbleToMakeAPostRequestUsingRequestPlugin({ request }: TestContext) {
  ...
  @Test()
  public async shouldBeAbleToMakeAPutRequestUsingRequestPlugin({ request }: TestContext) {
  ...
  @Test()
  public async shouldBeAbleToMakeADeleteRequestUsingRequestPlugin({ request }: TestContext) {
  ...
  @Test()
  public async shouldBeAbleToMakeAPatchRequestUsingRequestPlugin({ request }: TestContext) {
  ...
  @Test()
  public async shouldBeAbleToMakeAGetRequestThatReturnsAnArrayUsingRequestPlugin({ request }: TestContext) {
